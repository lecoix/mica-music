...
> 2026-09-11 适用性复核：这是 hybrid4–hybrid8 / Exo-only 早期性能调查档案。当前 App 基线是 **0.4.0/code54**；下方 0.1.8-hybrid8 只表示当时取证版本，不是“当前版本”。当前发布前结论见 `CURRENT_FEATURE_STATUS.md` / `TESTING.md`。

> **当前分支**：`exoplayer-only`
>
> **调查快照版本**：`0.1.8-hybrid8`（`versionCode 15`）
>
> **最近整理**：2026-09-11（原始调查：2026-06-20）
>
