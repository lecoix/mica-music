...
const val DEFAULT_STATUS_BAR_LYRICS_HORIZONTAL_OFFSET_DP = 0
...
const val MAX_STATUS_BAR_LYRICS_TOP_OFFSET_DP = 60
const val MIN_STATUS_BAR_LYRICS_HORIZONTAL_OFFSET_DP = -120
const val MAX_STATUS_BAR_LYRICS_HORIZONTAL_OFFSET_DP = 120
