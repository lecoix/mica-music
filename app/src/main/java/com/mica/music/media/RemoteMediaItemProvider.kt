    ...
    fun decode(item: MediaItem): Song? {
        ...
        return Song(
            ...
            metadata = TrackMetadata(
                ...
                sampleRateHz = RemoteMediaMetadataExtras.sampleRateHz(extras),
                bitsPerSample = RemoteMediaMetadataExtras.bitsPerSample(extras),
                bitrateKbps = RemoteMediaMetadataExtras.bitrateKbps(extras),
                channelCount = RemoteMediaMetadataExtras.channelCount(extras),
