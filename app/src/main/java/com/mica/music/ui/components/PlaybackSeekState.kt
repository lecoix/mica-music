...
internal fun rememberPlaybackSeekState(
    ...
    onSeekUiActiveChanged: (Boolean) -> Unit,
    onSeekToMs: (Int) -> Unit,
): PlaybackSeekState {
    ...
    val liveTotalMs = progressState.durationMs.coerceAtLeast(1)
    val totalMs = when {
    ...
    val liveSec = progressState.positionMs.coerceIn(0, liveTotalMs) / 1000f
