...
data class HifiTypography(
    val sansFamily: FontFamily = SansFamily,
    val lyricFamily: FontFamily = sansFamily,
    ...
    val lyricCurrent: TextStyle = TextStyle(
        fontFamily = lyricFamily, fontWeight = FontWeight.Bold,
        fontSize = 22.sp, lineHeight = 32.sp
    ),
    val lyricOther: TextStyle = TextStyle(
        fontFamily = lyricFamily, fontWeight = FontWeight.Normal,
        fontSize = 16.sp, lineHeight = 24.sp
    ),
)
