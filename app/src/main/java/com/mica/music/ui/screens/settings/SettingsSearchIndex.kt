...
internal object SettingsSearchIndex {
    val entries: List<SettingsIndexEntry> = listOf(
        ...
        setting("playback.content-color", "播放页 UI 颜色", "文字颜色", "前景色", category = SettingsCategory.PLAYBACK, section = SettingsIndexSections.PLAYBACK_COVER),
        ...
        setting("playback.custom-layout", "自定义播放页下半区布局", "布局", "拖动", "自定义标准", category = SettingsCategory.PLAYBACK, section = SettingsIndexSections.PLAYBACK_COVER, availability = "仅自定义标准主题"),
        ...
        setting("playback.immersive-lower", "下半屏沉浸", "沉浸", "下半屏", category = SettingsCategory.PLAYBACK, section = SettingsIndexSections.PLAYBACK_COVER, availability = "粒子封面、拍立得回忆不支持"),
        ...
        setting("lyrics.notification", "通知栏歌词", "通知", "媒体通知", category = SettingsCategory.LYRICS, section = SettingsIndexSections.LYRICS_OUTPUT, availability = "受系统通知和媒体会话条件影响"),
        setting("lyrics.car-bluetooth", "车载蓝牙歌词", "蓝牙", "车机", "媒体会话", category = SettingsCategory.LYRICS, section = SettingsIndexSections.LYRICS_OUTPUT, availability = "需要车载蓝牙设备", isExperimental = true),
