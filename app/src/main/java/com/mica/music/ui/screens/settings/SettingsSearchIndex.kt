...
internal object SettingsSearchIndex {
    val entries: List<SettingsIndexEntry> = listOf(
        ...
        setting(
            "appearance.mini-player-lyrics",
            "迷你播放栏歌词",
            "迷你播放", "歌词", "关闭", "整行", "逐字", "卡拉 OK",
            section = SettingsIndexSections.MINI_PLAYER,
        ),
        setting(
            "appearance.mini-player-swipe",
            "滑动切歌",
            "迷你播放", "滑动", "切歌", "无", "上一首", "下一首",
            "左滑", "右滑",
            section = SettingsIndexSections.MINI_PLAYER,
        ),
        ...
        setting("playback.cover-edge-progress", "封面底边进度", "进度条", "频谱", "封面边缘", category = SettingsCategory.PLAYBACK, section = SettingsIndexSections.PLAYBACK_COVER, availability = "标准主题支持主题色、模糊背景与星图；特殊主题有独立能力条件"),
        ...
        setting("playback.hires-badge", "Hi-Res 标志", "Hi-Res", "高解析度", "徽标", "样式", "自定义图片", "选择图片", "移除图片", category = SettingsCategory.PLAYBACK, section = SettingsIndexSections.PLAYBACK_INFO),
        ...
        setting("lyrics.bilingual", "双语歌词", "双语", "不分割", "拆分", "全部", "仅原文", "仅译文", "翻译", category = SettingsCategory.LYRICS, section = SettingsIndexSections.LYRICS_GENERAL),
        ...
        setting("lyrics.font", "歌词字体", "字体", "TTF", "OTF", "系统默认", "导入", "重新导入", category = SettingsCategory.LYRICS, section = SettingsIndexSections.LYRICS_FONT),
        ...
        setting("library.scan-all", "扫描系统音乐库", "扫描全部音乐", "扫描", "MediaStore", category = SettingsCategory.LIBRARY, section = SettingsIndexSections.LIBRARY_SOURCE),
        ...
        setting(
            "audio.auto-play-on-launch",
            "启动时自动播放",
            "自动播放", "启动播放", "打开应用播放", "续播",
            category = SettingsCategory.AUDIO,
            section = SettingsIndexSections.AUDIO,
            availability = "默认关闭；Service 恢复队列仍为暂停，打开应用后由播放控制器请求一次播放",
        ),
