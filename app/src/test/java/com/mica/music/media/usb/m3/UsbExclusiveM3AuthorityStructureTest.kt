...
class UsbExclusiveM3AuthorityStructureTest {
    ...
    fun productionUsesProtocolForCommandsAndKeepsLegacyAuthorityOutOfProductionBranches() {
        ...
        assertTrue(direct.contains("if (playbackAdapter == null) transitionCoordinator?.onDirectReleased"))
        assertTrue(direct.contains("if (playbackAdapter == null) transitionCoordinator?.beforeDirectAccept"))
